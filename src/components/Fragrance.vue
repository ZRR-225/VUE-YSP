...
export default {
  ...
  mounted(){
    axios.get("/app/search/product?limit=20&offset=0&categoryId=361,362,369,364,365,368,363,367&sortField=RELEASE&sortOrder=DESC").then(res=>{
  ...
  methods:{
    ...
    loadMore(){
      ...
      axios.get(`/app/search/product?limit=20&offset=${this.current}&categoryId=361,362,369,364,365,368,363,367&sortField=RELEASE&sortOrder=DESC`).then(res=>{
